...
<%@page import="tiny.java.entities.Alumno"%>
<%@page import="tiny.java.entities.Curso"%>
<%@page import="tiny.java.repositories.jdbc.AlumnoRepository"%>
<%@page import="tiny.java.repositories.interfaces.I_AlumnoRepository"%>
